...
func (t *Table) GetQuery(session cqlx.Session, columns ...string) *cqlx.Queryx {
	return session.Query(t.Get(columns...))
}

// GetQueryContext returns query wrapped with context which gets by primary key.
func (t *Table) GetQueryContext(ctx context.Context, session cqlx.Session, columns ...string) *cqlx.Queryx {
...
func (t *Table) SelectQuery(session cqlx.Session, columns ...string) *cqlx.Queryx {
...
func (t *Table) SelectQueryContext(ctx context.Context, session cqlx.Session, columns ...string) *cqlx.Queryx {
...
func (t *Table) InsertQuery(session cqlx.Session) *cqlx.Queryx {
	return session.Query(t.Insert())
}

// InsertQueryContext returns query wrapped with context which inserts all columns.
func (t *Table) InsertQueryContext(ctx context.Context, session cqlx.Session) *cqlx.Queryx {
...
func (t *Table) UpdateQuery(session cqlx.Session, columns ...string) *cqlx.Queryx {
	return session.Query(t.Update(columns...))
}

// UpdateQueryContext returns query wrapped with context which updates by primary key.
func (t *Table) UpdateQueryContext(ctx context.Context, session cqlx.Session, columns ...string) *cqlx.Queryx {
...
func (t *Table) DeleteQuery(session cqlx.Session, columns ...string) *cqlx.Queryx {
	return session.Query(t.Delete(columns...))
}

// DeleteQueryContext returns query wrapped with context which delete by primary key.
func (t *Table) DeleteQueryContext(ctx context.Context, session cqlx.Session, columns ...string) *cqlx.Queryx {
